...
public class JMfood4 extends HttpServlet {
...
int amount=sn1*205+ sn2*189 + sn3*155 + sn4*45 + sn5*39 + sn6*179 + sn7*19 + sn8*155;
...
{
Logger.getLogger(JMfood4.class.getName()).log(Level.SEVERE, null, ex);
}
}
}
