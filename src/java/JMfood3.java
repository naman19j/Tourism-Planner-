...
public class JMfood3 extends HttpServlet {
...
int amount=sn1*135 + sn2*100 + sn3*130 + sn4*28 + sn5*32 + sn6*125 + sn7*110 + sn8*140;
...
{
Logger.getLogger(JMfood3.class.getName()).log(Level.SEVERE, null, ex);
}
}
}
