...
public class rishfood4 extends HttpServlet {
...
int amount=sn1*250+ sn2*150 + sn3*450 + sn4*60 + sn5*25 + sn6*129 + sn7*10 + sn8*300;
...
{
Logger.getLogger(rishfood4.class.getName()).log(Level.SEVERE, null, ex);
}
        }
}
