...
public class CHARDHAMfood3 extends HttpServlet {
...
int amount=sn1*200+ sn2*200 + sn3*169 + sn4*60 + sn5*25 + sn6*179 + sn7*10 + sn8*155;
...
{
Logger.getLogger(CHARDHAMfood3.class.getName()).log(Level.SEVERE, null, ex);
}
}
}
