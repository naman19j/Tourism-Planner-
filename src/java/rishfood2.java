...
public class rishfood2 extends HttpServlet {
...
int amount=sn1*159+ sn2*150 + sn3*70 + sn4*60 + sn5*25 + sn6*179 + sn7*10 + sn8*155;
...
{
Logger.getLogger(rishfood2.class.getName()).log(Level.SEVERE, null, ex);
}
}
}
