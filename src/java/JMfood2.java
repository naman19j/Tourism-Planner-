...
public class JMfood2 extends HttpServlet {
...
int amount=sn1*130 + sn2*105 + sn3*55 + sn4*50 + sn5*80 + sn6*150 + sn7*220 + sn8*80;
...
{
Logger.getLogger(JMfood2.class.getName()).log(Level.SEVERE, null, ex);
}
}
}
